...
We evaluate this interface in motion and motionless mode. The system can distinguish swipe gestures with high accuracy (93.2\%). For motionless mode, it can achieve 82.4\% accuracy for classifying different kinds of finger postures.
...
The pilot study showed, fingernail width is 1.145cm (SD=0.14) and height is 1.21cm (SD=0.17). 
