...
In this paper, we developed a prototype, \projectName{} (\autoref{fig:main}), use a 3$\times$3 array of strain gauges sensor to explore the strains from fingernail as input technique.
...
\begin{figure}[t!]
  \includegraphics[width=1\columnwidth]{figures/CompleteDiagram_v4.pdf}
...
\begin{figure}[t!]
  ...
  \caption{The apparatus in our user study. At the surface, we put a load-cell sensor below. For each user, we put a 9DOF sensor on finger and our \projectName{} device on fingernail.}
  \label{fig:apparatus}
\end{figure}
